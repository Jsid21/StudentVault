...
export const Display = ({ sessionDetail }) => {
  ...
  useEffect(() => {
    const fetchPostDetails = async () => {
      try {
        ...
        const response = await axios.get(`https://studentvault-server.onrender.com/api/posts/${postId}`, {
          headers: {
  ...
  const handleDelete = async () => {
    try {
      ...
      await axios.delete(`https://studentvault-server.onrender.com/api/posts/${postId}`, {
        headers: {
